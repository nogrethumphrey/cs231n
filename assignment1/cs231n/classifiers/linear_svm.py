...
def svm_loss_vectorized(W, X, y, reg):
  ...
  #############################################################################
  num_train = X.shape[0]
  all_sample_scores = X.dot(W)
  correct_class_score = all_sample_scores[np.arange(num_train), y]
  margins = np.maximum(0, all_sample_scores - correct_class_score[:, np.newaxis] + 1)
